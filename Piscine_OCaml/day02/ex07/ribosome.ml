...
let main () =
  Random.self_init ();
  print_endline (string_of_triplets (generate_bases_triplets (generate_rna (generate_helix 20))));
  print_endline (string_of_triplets (generate_bases_triplets (generate_rna (generate_helix_by_char ['A'; 'T'; 'G'; 'G'; 'A'; 'C']))));
  print_endline (string_of_triplets (generate_bases_triplets (generate_rna (generate_helix_by_char ['A'; 'T'; 'G'; 'G'; 'A'; 'C'; 'T'; 'G'; 'G'; 'A'; 'C'; 'T'; 'G'; 'G'; 'A'; 'C'; 'C'; 'C']))));
  print_endline (string_of_protein (create_protein (generate_bases_triplets (generate_rna (generate_helix_by_char ['T'; 'A'; 'C';'A'; 'T'; 'T'; 'A'; 'T'; 'C'; 'A'; 'C'; 'T'])))));
  print_endline (string_of_protein (create_protein (generate_bases_triplets (generate_rna (generate_helix 10)))))
