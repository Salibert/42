...
RobotomyRequestForm::RobotomyRequestForm(void) : AForm(NULL, NULL,0, 0) { return; }
...
RobotomyRequestForm::RobotomyRequestForm(std::string name, int gradeExec, int gradeSigned) :
    AForm("robotomy request", name, gradeExec, gradeSigned) { return ;}

RobotomyRequestForm::RobotomyRequestForm(std::string name) :
    AForm("robotomy request", name, 45, 72) { return ;}
